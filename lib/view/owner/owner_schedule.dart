...
class _OwnerSchedule extends State<OwnerSchedule> {
  ...
  void initState() {
    ...
    Provider.of<OwnerScheduleViewModel>(context,
        listen: false).getSchedule(DateTime
        .now()
        .year, DateTime
        .now()
        .month);
            ...
            children: [
              ...
              Container(
                ...
                child: const Column(
                  ...
                  children: [
                    Text("아티스트 : 뉴진스 민지", style: TextStyle(
                        color: Palette.primary,
                        fontFamily: 'Pretendard',
                        fontWeight: FontWeight.w700,
                        fontSize: 14),),
                    SizedBox(height: 13.5,),
                    Text("닉네임 : 홍길동", style: TextStyle(color: Palette.gray10,
                        fontFamily: 'Pretendard',
                        fontWeight: FontWeight.w500,
                        fontSize: 14),),
                    SizedBox(height: 13.5,),
                    Text("일정 : 2024.01.01~2024.01.01", style: TextStyle(
