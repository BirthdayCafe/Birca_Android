      ...
      bottomNavigationBar: const Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            BircaOutLinedButton(text: '대관 요청하기', radiusColor: Palette.primary, backgroundColor: Palette.primary, width: 160, height: 44, radius: 6, textColor: Colors.white, textSize: 14),
            SizedBox(width: 14,),
            BircaOutLinedButton(text: '전화하기', radiusColor: Palette.primary, backgroundColor: Colors.white, width: 160, height: 44, radius: 6, textColor: Palette.primary, textSize: 14)
          ],
        ),
      )
    );
