...
import 'package:birca/view/host/host_select_artist.dart';
...
class HostRequest extends StatefulWidget {
  final int cafeID;

  const HostRequest({Key? key, required this.cafeID}) : super(key: key);
                  ...
                  BircaOutLinedButton(
                    ...
                    onPressed: ()  async {
                      final result = await Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const HostSelectArtist()));
