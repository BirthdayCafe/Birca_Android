...
class SelectInterestArtistScreen extends StatefulWidget {
  ...
  @override
  SelectInterestArtistScreenState createState() => SelectInterestArtistScreenState();
}

class SelectInterestArtistScreenState extends State<SelectInterestArtistScreen> {
  int expandedIndex = -1;
  late int location;
