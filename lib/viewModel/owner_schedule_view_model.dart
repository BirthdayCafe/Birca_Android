...
class OwnerScheduleViewModel extends ChangeNotifier {
  ...
  // OwnerScheduleAddModel? _ownerScheduleAddModel;
  //
  // OwnerScheduleAddModel? get ownerScheduleAddModel => _ownerScheduleAddModel;
  ...
  Future<void> postSchedule(OwnerScheduleAddModel ownerScheduleAddModel) async {
    ...
    try {
      // API 엔드포인트 및 업로드
      Response response = await dio.post('${baseUrl}api/v1/owners/birthday-cafes/schedules',
