...
class OwnerMyCafeViewModel extends ChangeNotifier {
  ...
  //사장님 나의 카페 편집
  Future<void> patchMyCafe(String cafeName, String cafeAddress,String twitter, String hours,List<Map<String, Object>> cafeMenu,List<Map<String, Object>> cafeOptions) async {
    // const storage = FlutterSecureStorage();
    var baseUrl = dotenv.env['BASE_URL'];
    var token = '';
